...
const tabs = computed(() => {
    const commonTabs = [
        ...
        { id: 'welcome', label: 'Welcome Content' },
    ];
    ...
    >
        <div class="flex items-center justify-between border-b border-slate-200 px-3.5 py-3.5">
            ...
            <button
                ...
                class="inline-flex h-8 w-8 items-center justify-center rounded-lg text-slate-500 transition hover:bg-slate-100 hover:text-slate-950"
            ...
            <div class="flex min-h-screen items-center justify-center p-4">
                ...
                <div class="relative bg-white rounded-2xl shadow-xl max-w-sm w-full p-6 text-center border border-slate-200 z-10 animate-in fade-in zoom-in-95 duration-150">
                    ...
                    <p class="text-xs text-slate-500 mt-1.5 leading-relaxed">
                        You will need to sign in again to access the MEO superadmin console.
                    </p>
