...
<template>
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="flex">
            <Sidebar :activeTab="activeTab" @tab-change="handleTabChange" @collapse-change="handleCollapseChange" />
            ...
            <div :class="['flex-1 flex flex-col min-h-screen transition-all duration-200', sidebarCollapsed ? 'lg:ml-20' : 'lg:ml-64']">
                ...
                <div class="flex-1 px-4 sm:px-6 lg:px-8 py-6 overflow-visible flex flex-col">
